...
"use strict";var $=jQuery.noConflict();$(function(){$(".rightside-menu__open").on("click",function(){$(".rightside-menu").removeClass("rightside-menu--close")}),$(".rightside-menu__close").on("click",function(){$(".rightside-menu").addClass("rightside-menu--close")})}),$(function(i){$(".reviews__slider").slick({dots:!1,arrows:!1,fade:!0,autoplay:!0});mixitup(".gallery__inner",{load:{filter:".living"}})});
